<?php
    ...
    final class Route
    {
        ...
        public static function put(string $pattern, string $controller, string $method): Route
        {
            return new Route("PUT", $pattern, $controller, $method);
        }

        public static function delete(string $pattern, string $controller, string $method): Route
        {
